<script>
	...
	import MobileMyAccountBillingAddressContent from './MobileMyAccountBillingAddressContent.svelte';
...
<style>
	...
	.tab-link:nth-child(odd) {
		margin-right: 2px;
	}
	.tab-link:nth-child(even) {
		margin-left: 2px;
	}
...
<div class="">
	<div class="tab-header flex flex-wrap mb5">
		<a
			href="/my-account"
	...
	<div class="tab-body">
		<MobileMyAccountBillingAddressContent
