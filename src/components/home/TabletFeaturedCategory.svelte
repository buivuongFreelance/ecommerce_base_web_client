...
{#if visible}
	<div class="custom">
		<div class="flex">
			...
			<div class="featuredCategory bg-light-gray sell flex-1 mh1rem">
				<div class="image relative flex-1 flex items-end">
			...
			<div class="featuredCategory bg-light-gray exchange flex-1">
...
{:else}
	<div class="flex justify-center mv4">
		<ContentLoader width="768" uniqueKey="featuredCategory">
