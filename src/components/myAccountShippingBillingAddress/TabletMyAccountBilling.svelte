...
{#if values}
	<div class="w-100">
		<h3 class="ttc mb5">{$_('checkout.billingAdd')}</h3>
		<div class="pb5 flex">
		...
		{#if !isSameShipping}
			...
			<div class="mt40" id="addressBill">
				...
				<input
					class="ba b--light-gray br2 fw6 f6 light-silver w-500px h-40-px mt3 ph3
				w-100"
					type="text"
				...
				<div class="flex">
					<div class="mr4" id="phoneBill">
						...
						<PcMaskInput
							...
							className={errors.phoneBill ? 'ba b--red br2 fw6 f6 light-silver h-40-px mt3 ph3 w-123px pl3' : 'pl3 ba b--light-gray br2 fw6 f6 light-silver h-40-px mt3 ph3 w-123px'}
					...
					<div id="postalCodeBill">
						<label
							...
							for="postalCodeBill">{$_('checkout.zip')}</label>
						<input
