<script>
	...
	import PcModalSelectModel from '../modal/PcModalSelectModel.svelte';
...
{#if isOpenModel}
	<Portal target={document.getElementById('portal')}>
		...
		<PcModalSelectModel onClose={() => (isOpenModel = false)} />
	</Portal>
{/if}
...
<div class="panel bg-light-gray br--top flex items-center justify-between pl4">
	...
	<div
		class="btn-skip link fw6 ph3 h-50-px white bg-light-blue flex items-center
...
<div
	class="w-100 flex items-center justify-center b--light-gray ba br2 br--bottom
		pa5">
	<div>
		<div class="f4 mt3 near-black b tc">{$_('device.descExchangeDevice')}</div>
