...
<div id="warranty" class="flex">
	<div class="flex justify-end w-label-pc">
		<div class="flex justify-center">
			<div class="light-silver fw6" class:red={error}>
	...
	<div>
		<div>
			<label class="radio mr3 pointer light-silver">
				<input
					type="radio"
				...
				<span class="box" />
				<span class="label fw6 ml3 f4">{$_('message.expireDate')}</span>
			</label>
		...
		<div class="mt4">
			<label class="light-silver radio pointer">
				<input
					...
					on:change={(event) => onChangeWarranty(event.target.value)} />
				<span class="box" />
				<span class="label fw6 ml3 f4">{$_('device.expired')}</span>
			</label>
		...
		<div class="mt4">
			<label class="light-silver radio pointer">
				<input
					...
					on:change={(event) => onChangeWarranty(event.target.value)} />
				<span class="box" />
				<span class="label fw6 ml3 f4">{$_('message.unknown')}</span>
			</label>
...
<div class="flex">
	<div class="flex justify-end w-label-pc">
		<div class="flex justify-center">
			<div class="light-silver fw6" class:red={errorAccessories === true}>
