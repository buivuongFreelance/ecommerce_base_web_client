...
<form autocomplete="off" on:submit|preventDefault={handleSubmit} novalidate>
	<h4 class="fw6 mb3">{$_('account.changePassword')}</h4>
	<p class="mb6">
		Lorem ipsum dolor sit, amet consectetur, adipisicing elit. Harum excepturi
		iste velit architecto commodi, perferendis. Natus nisi quasi deserunt nemo
		neque, hic ex iste, illo? Suscipit architecto velit, eos quae.
	</p>
	<div class="flex mb4">
		<div class="fw6 label lh-50-px">{$_('account.currentPassword')}</div>
		<div class="flex-1">
			<InputPassword
	...
	<div class="flex mb4">
		<div class="fw6 label lh-50-px">{$_('account.newPassword')}</div>
		<div class="flex-1">
			<InputPassword
				name="newPassword"
	...
	<div class="flex mb4">
		<div class="fw6 label lh-50-px">{$_('account.confirmNewPassword')}</div>
		<div class="flex-1">
			<InputPassword
	...
	<div class="flex justify-end">
		<button
			type="button"
			class="btn h-50-px tc ph5 fw6 bg-light-gray near-black ba b--light-gray br1 mr3 pointer grow">Cancel</button>
		{#if isLoading}
			<button
				type="submit"
		...
		{:else}
			<button
				type="submit"
				class="btn h-50-px tc ph5 fw6 bg-dark-blue white ba b--dark-blue br1 pointer grow">Save</button>
		{/if}
	</div>
</form>
