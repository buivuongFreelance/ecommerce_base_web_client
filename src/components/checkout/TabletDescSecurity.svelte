...
<div class="flex w-security mt4">
	<svg
		...
		fill="black"
		width="40"
		height="40"><rect fill="none" height="24" width="24" />
		<path
	...
	<div class="w-security-content ml3">
		<h4 class="mb3">{$_('checkout.securityPrivacy')}</h4>
		<span>
			{$_('checkout.descSecurity')}
			<a class="link blue fw6" href="/">{$_('checkout.privacy')}</a>
		</span>
	</div>
</div>
