			...
			<div class="flex">
				<div class="mr4" id="phoneShip">
					...
					<PcMaskInput
						...
						className={errors.phoneShip ? 'pl3 ba b--red br2 fw6 f6 light-silver h-40-px mt3 ph3 w-small' : 'pl3 ba b--light-gray br2 fw6 f6 light-silver h-40-px mt3 ph3 w-small'}
