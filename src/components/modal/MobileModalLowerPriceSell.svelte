	...
	<div class="w-100 bg-white container">
		...
		<div class="pa3 content">
			...
			{:else}
				...
				<div class="mt4">
					...
					<div class="container-inputNumber flex">
						<input
							type="number"
							id="inputNumber"
							class="inputNumber pa4 b f3 bn w-100 flex-1"
							on:input={(e) => handleInput(e)}
							bind:this={inputWrapper}
						/>
						<label
							for="inputNumber"
							class="pointer bg-light-gray ph4 bl b--light-gray flex items-center justify-center f3 b"
							>{$currency}</label
						>
					</div>
					{#if errorPrice !== null}
				...
				<div class="mt3 mb5 flex justify-between">
					<div />
				...
				<div class=" flex justify-end">
					{#if isLoadingLowerPrice}
						<button
							type="button"
							disabled
							class="btn-submit w-50 h-40-px bg-dark-blue white bn br2 grow pointer fw6 ttu tc dif items-center justify-center"
						>
					...
					{:else}
						<button
							...
							type="button"
							class="btn-submit w-50 h-40-px bg-dark-blue white bn br2 grow pointer fw6 ttu"
