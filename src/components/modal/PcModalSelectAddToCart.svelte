				...
				<div class="mb4">
					<label class="light-silver radio pointer">
						...
						<span
							...
							class:dark-blue={typeAdd === config.sell}>{$_('cart.buyThisDevice')}</span>
					</label>
			...
			<div class="flex items-start justify-between spacing-ext pt4">
				<div class="mb4">
					<label class="light-silver radio pointer">
						...
						<span
							class="label fw6 ml3 f4"
							class:red={item.real_exchange_price >= 0 && typeAdd === config.exchange}
							class:dark-blue={item.real_exchange_price < 0 && typeAdd === config.exchange}>{$_('cart.exchangeThisDevice')}</span>
					</label>
					<p
						class="ml5 light-silver"
						class:red={item.real_exchange_price >= 0 && typeAdd === config.exchange}
						class:dark-blue={item.real_exchange_price < 0 && typeAdd === config.exchange}>
