...
{:else if isLoading}
	<ContentLoader width="768" height="300" uniqueKey="compare">
		<rect x="0" y="0" rx="5" ry="5" width="768" height="300" />
	</ContentLoader>
{:else}
	<h3 class="mb5">
		{item.model}
	...
	<div class="row flex mb3">
										...
										{:else}
											<span
												...
												<svg
													...
													height="20"
													viewBox="0 0 24 24"
													width="20"><path d="M0 0h24v24H0V0z" fill="none" />
													<path
		...
		<div class="column w-33">
			<div class="flex items-start ba b--light-gray pa3 br2 h-100 relative">
				{#if $compareItemTwo}
					<picture
						class="picture db br1 ba b--light-gray mr3 flex items-center justify-center pointer"
