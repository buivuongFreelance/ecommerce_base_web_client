<script>
	import MobileModalSearch from '../modal/MobileModalSearch.svelte';
...
{#if isOpen}
	<MobileModalSearch onClose={handleCloseModalSearch} />
{/if}
<div
	class="dim bw0 ph3 h-60-px flex items-center"
