			...
			<div class="swiper-wrapper">
				<div class="swiper-slide">
					...
					<div class="slide-container">
						<div class="slide-content">
							<div class="slide-text ttu">
								<h1 class="slide-title dark-blue">
									{$_('banner.slide1Title')}
								</h1>
								<h3 class="slide-subtitle mb5">
									{$_('banner.slide1Subtitle')}
								</h3>
								<h5 class="mb3 fw4">{$_('home.downloadTheAppNow')}</h5>
								<div class="downloads flex">
									<a href={config.appStore} class=" pointer grow mr3">
										<img
									...
									<a href={config.googlePlay} class=" pointer grow">
										<img
				...
				<div class="swiper-slide">
					...
					<div class="slide-container">
						...
						<div class="slide-image flex justify-end items-end h-100 pt5">
							<!-- <img src="images/slideshow3_mobile.png" alt="slideshow3_mobile" /> -->
						</div>
					</div>
				</div>
			</div>
