	...
	{:else if isLoading}
		<div class="pb5">
			<ContentLoader
				...
				width={800}
				height="200">
				<rect x="0" y="0" rx="3" ry="3" width="768" height="40" />
				<rect x="0" y="60" rx="3" ry="3" width="768" height="20" />
				<rect x="0" y="100" rx="3" ry="3" width="768" height="20" />
				<rect x="0" y="140" rx="3" ry="3" width="768" height="20" />
				<rect x="0" y="180" rx="3" ry="3" width="768" height="20" />
			</ContentLoader>
		</div>
	{:else}
