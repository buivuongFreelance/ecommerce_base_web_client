...
<div class="wrapper-custom mt5 tc">
	...
	<h2 class="mb3 mt3 ttc">{$_('message.passcode')}</h2>
	<div class="light-silver">{$_('message.passcodeDesc')}</div>

	<form on:submit|preventDefault={handleSubmit} novalidate class="mt5">
		<div class="input relative">
			...
			{#if isShowPassCode}
				<input
					...
					class="input-default ph5 w-100 h-60-px db ba b--light-gray f4 bg-white near-black tc br2"
