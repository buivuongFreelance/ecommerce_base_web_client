...
<div class="progress-wrapper mb5 mt1rem">
...
{#if progressStep === 1}
	<div class="flex">
		...
		<div class="w-60 pl2rem">
			<div class="f5">Go to <b>settings</b></div>
			<div class="mt3">
...
{#if progressStep === 2}
	<div class="flex">
		...
		<div class="w-60 pl2rem">
			<div class="f5">Tap <b>[ your name ]</b></div>
...
{#if progressStep === 3}
	<div class="flex">
		...
		<div class="w-60 pl2rem">
			<div class="f5">Scroll down and tap <b>Sign Out</b></div>
			<div class="mt3">
				<label class="checkbox-default">
					<input type="checkbox" bind:checked={agree} />
					<span />
...
{#if progressStep === 4}
	<div class="flex">
		...
		<div class="w-60 pl2rem">
			<div class="f5">Tap <b>Sign Out of iCloud</b></div>
			<div class="mt3">
				<label class="checkbox-default">
					<input type="checkbox" bind:checked={agree} />
					<span />
