...
<div class="custom">
	<div class="flex justify-between items-center">
		<div class="b f4 ttc mb3">Scan your device</div>
		{#if $scanTransactionTimeout}
	...
	<div class="progress-wrapper mb5">
		...
		<div class="progress">
			<div class="progress-bar" style="width: {(progressStep * 100) / 17}%" />
		</div>
	</div>
	{#if progressStep === 1}
		<div class="flex items-center">
			...
			<div class="w-60 pl6">
				<div class="f4">
					Open the
					<b class="pointer dim"> Dingtoi Pro Phone Checker </b>
					App.
				</div>
				<div class="mt3">
	...
	{#if progressStep === 2}
		<div class="flex items-center">
			<div class="w-40 flex justify-end">
				<img
					src="images/transaction_scan_2.jpg"
					alt="transaction_scan_2"
					class="image pointer"
				/>
			</div>
			<div class="w-60 pl6">
	...
	{#if progressStep === 4}
		<div class="flex items-center">
			<div class="w-40 flex justify-end">
				<img
					src="images/transaction_scan_4.jpg"
					alt="transaction_scan_4"
					class="image pointer"
				/>
			</div>
			<div class="w-60 pl6">
		...
		<div class="flex items-center">
			...
			<div class="w-60 pl6">
				<div class="f4">
					<p>
						Tap
						<b class="pointer dim">scan qr code </b>
						button.
					</p>
				</div>
				{#if isLoading}
				...
				{:else if scanDeviceQrCodeLink}
					<div class="mt3">
						<div class="f4 mb3">
							and then <span class="mb3 b">Scan QR code.</span>
						</div>
		...
		<div class="flex items-center">
			...
			<div class="w-60 pl6">
				...
				<div class="f4">
					<p>
						Tap
						<b class="pointer dim">complete</b>.
					</p>
				</div>
				<div class="flex mt5">
					<PcButtonPrev onClickButton={prevProgressStep} className="mr3" />
	...
	<div class="flex justify-center mt5">
		<button
			type="button"
			on:click={() => step--}
			class="btn--cancel bn br2 bg-light-gray pv3 ph5 near-black pointer grow fw6 mr3"
			>{$_('transaction.backToDownloadApp')}</button
		>
		{#if progressStep > 5}
			<button
				type="button"
				on:click={handleRestart}
				class="btn--cancel bn br2 bg-light-silver pv3 ph5 white pointer grow fw6"
				>{$_('transaction.restart')}</button
			>
		{/if}
	</div>
</div>
