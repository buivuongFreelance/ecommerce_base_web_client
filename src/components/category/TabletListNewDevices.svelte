...
{#if isServerError}
	<p class="tc mv4 red f5">{$_('error.serverErrorMessage')}</p>
{:else if isLoading}
	<ContentLoader
		uniqueKey="category"
		primaryColor="#e4e6ef"
		...
		height="500"
	>
		<rect x="0" y="0" rx="3" ry="3" width="240" height="240" />
		<rect x="250" y="0" rx="3" ry="3" width="240" height="240" />
		<rect x="500" y="0" rx="3" ry="3" width="240" height="240" />

		<rect x="0" y="250" rx="3" ry="3" width="240" height="10" />
		<rect x="0" y="270" rx="3" ry="3" width="200" height="10" />
		<rect x="0" y="290" rx="3" ry="3" width="180" height="10" />
		<rect x="0" y="310" rx="3" ry="3" width="120" height="10" />
		<rect x="0" y="330" rx="3" ry="3" width="160" height="10" />
		<rect x="0" y="350" rx="3" ry="3" width="90" height="10" />

		<rect x="250" y="250" rx="3" ry="3" width="240" height="10" />
		<rect x="250" y="270" rx="3" ry="3" width="200" height="10" />
		<rect x="250" y="290" rx="3" ry="3" width="180" height="10" />
		<rect x="250" y="310" rx="3" ry="3" width="120" height="10" />
		<rect x="250" y="330" rx="3" ry="3" width="160" height="10" />
		<rect x="250" y="350" rx="3" ry="3" width="90" height="10" />

		<rect x="500" y="250" rx="3" ry="3" width="240" height="10" />
		<rect x="500" y="270" rx="3" ry="3" width="200" height="10" />
		<rect x="500" y="290" rx="3" ry="3" width="180" height="10" />
		<rect x="500" y="310" rx="3" ry="3" width="120" height="10" />
		<rect x="500" y="330" rx="3" ry="3" width="160" height="10" />
		<rect x="500" y="350" rx="3" ry="3" width="90" height="10" />
	</ContentLoader>
