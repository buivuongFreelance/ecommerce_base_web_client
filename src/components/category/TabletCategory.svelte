<script>
	...
	import TabletListDeviceCategory from './TabletListDeviceCategory.svelte';
	import TabletSort from './TabletSort.svelte';
...
{:else}
	...
	{/if}
	<div class="w-100 sort-wrapper bg-white b--light-gray bb mb1rem">
		<TabletSort {countList} bind:sort bind:isOpenDrawer />
	</div>
	<div class="list">
		{#if countFilter > 0 && isOpenDrawer === false}
			<div class="tags flex flex-wrap mb1rem pb1rem bb b--light-gray">
