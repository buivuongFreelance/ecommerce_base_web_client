...
<div transition:fade class="z-max absolute bg-white top-drop">
	...
	{:else if isLoading}
		<ContentLoader width="748" height="225" uniqueKey="searchContentLoading">
			<rect x="20" y="0" rx="5" ry="5" width="748" height="50" />
			<rect x="20" y="60" rx="5" ry="5" width="748" height="50" />
			<rect x="20" y="120" rx="5" ry="5" width="748" height="50" />
			<rect x="20" y="180" rx="5" ry="5" width="748" height="50" />
		</ContentLoader>
