...
<div class="link dark-blue pl3 h-70-px flex items-center pointer fw6">
	<div
		...
		{#if isOpenMenu}
			<ul
				transition:fade
				class="z-max absolute list ma0 pv3 ph0 bg-white br2 shadow-1 popup
					top-drop">
				<li
					class="lh-copy"
					on:click={async () => {
					...
					<div class="pv3 spacing-ext flex items-center self-center">
						...
						<span class="ml3 near-black fw6">{$_('device.listDevice')}</span>
					</div>
				</li>
				<li
					class="lh-copy"
				...
				<li class="lh-copy pointer" on:click={handleSignOut}>
					<div class="pv3 spacing-ext flex items-center self-center">
						<svg
							xmlns="http://www.w3.org/2000/svg"
							viewBox="0 0 24 24"
