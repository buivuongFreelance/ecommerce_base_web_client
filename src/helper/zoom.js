	...
	return function ImageZoom(container, opts) {
		...
		function setZoomedImgSize(options, data) {
			if (options.scale) {
				...
				data.zoomedImg.element.style.height = options.zoomHeight + 'px';
			} else {
		...
		function setup() {
			...
			// or get sourceImg element from specified container
				...
				if (options.swiper) {
					data.sourceImg.element = document.querySelector('.swiper-slide-active img');
				} else {
			...
			container.addEventListener('click', opts.onClick, false);
		...
		function kill() {
			...
			container.removeEventListener('click', opts.onClick, false);
