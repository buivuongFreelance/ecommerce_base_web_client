<script>
	...
	import PcMyAccount from '../../components/myAccount/PcMyAccount.svelte';
	import MobileMyAccountProfile from '../../components/myAccountProfile/MobileMyAccountProfile.svelte';
			...
			<div class="content-mobile">
				<Breadcrumb>
					<BreadcrumbItem
						...
						href="my-account"
					/>
					<BreadcrumbItem active={true} message={$_('profile.title')} />
				</Breadcrumb>
				<section class="spacing-ext center pb1rem">
					<MobileMyAccountProfile />
				</section>
			</div>
