<script>
	...
	import PcMyWallet from '../../components/myWallet/PcMyWallet.svelte';
	import MobileMyWallet from '../../components/myWallet/MobileMyWallet.svelte';
			...
			<div class="content-mobile">
				<Breadcrumb>
					<BreadcrumbItem
						...
						href="my-account"
					/>
					<BreadcrumbItem active={true} message={$_('wallet.walletTitle')} />
				</Breadcrumb>
