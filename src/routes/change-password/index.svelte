<script>
	...
	import PcMyAccountChangePassword from '../../components/myAccountChangePassword/PcMyAccountChangePassword.svelte';
	import MobileMyAccountChangePassword from '../../components/myAccountChangePassword/MobileMyAccountChangePassword.svelte';
		...
		{#if deviceType === config.isMobile}
			...
			<div class="content-mobile">
				<Breadcrumb>
					...
					<BreadcrumbItem
						active={true}
						message={$_('account.changePassword')}
					/>
				</Breadcrumb>
				<section class="spacing-ext center pb2rem">
					<MobileMyAccountChangePassword />
				</section>
			</div>
