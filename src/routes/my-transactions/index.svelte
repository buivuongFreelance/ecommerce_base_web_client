<script>
	...
	import PcMyTransaction from '../../components/transaction/PcMyTransaction.svelte';
	import TabletNav from '../../components/menu/TabletNav.svelte';
	import TabletMyTransaction from '../../components/transaction/TabletMyTransaction.svelte';
	import MobileNav from '../../components/menu/MobileNav.svelte';
	import MobileMyTransaction from '../../components/transaction/MobileMyTransaction.svelte';
...
<svelte:head>
	<title>{$_('order.myTransPage')}</title>
</svelte:head>
{#if visible}
	<TransactionWrapper id="order-screen">
		{#if deviceType === config.isMobile}
			...
			<div class="content-mobile">
				<Breadcrumb>
					<BreadcrumbItem active={true} message={$_('order.myTrans')} />
				</Breadcrumb>
