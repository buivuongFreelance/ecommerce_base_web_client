<script>
	...
	import TabletTransactionScan from '../../../components/transactionScan/TabletTransactionScan.svelte';
	import MobileTransactionScan from '../../../components/transactionScan/MobileTransactionScan.svelte';
	import PcTransactionConfirmScan from '../../../components/transactionScan/PcTransactionConfirmScan.svelte';
...
<svelte:head>
	<title>{$_('transaction.transactionScanConfirm')}</title>
</svelte:head>
{#if visible}
	<TransactionWrapper id="order-screen">
		{#if deviceType === config.isMobile}
			...
			<div class="content-mobile">
				...
				<section class="pb2rem spacing-ext">
					<MobileTransactionScan
						bind:id
						bind:transCode
						bind:deviceName
						bind:deviceId
		...
		{:else}
			...
			<div class="content-desktop">
				<Breadcrumb>
					...
					<BreadcrumbItem
						active={true}
						message={$_('transaction.transactionScanConfirm')}
					/>
				</Breadcrumb>
				<section class="spacing-ext mw10 center pt3 pb5">
					<PcTransactionConfirmScan
						bind:id
						bind:transCode
						bind:deviceName
						bind:deviceId
