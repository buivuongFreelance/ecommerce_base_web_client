<script>
	...
	import PcTransactionScan from '../../../components/transactionScan/PcTransactionScan.svelte';
...
<svelte:head>
	<title>{$_('transaction.transactionScanPage')}</title>
</svelte:head>
{#if visible}
			...
			<div class="content-desktop">
				<Breadcrumb>
					...
					<BreadcrumbItem
						...
						message={transCode}
					/>
					<BreadcrumbItem active={true} message={$_('home.transactionScan')} />
				</Breadcrumb>
