<script>
	...
	import PcOrder from '../../components/order/PcOrder.svelte';
	import TabletOrder from '../../components/order/TabletOrder.svelte';
	import MobileOrder from '../../components/order/MobileOrder.svelte';
	...
	<TransactionWrapper id="order-screen">
		{#if deviceType === config.isMobile}
			...
			<div class="content-mobile">
				<Breadcrumb>
					<BreadcrumbItem active={true} message={$_('order.myOrder')} />
				</Breadcrumb>
				<section class="pb5">
					<MobileOrder />
				</section>
