...
<svelte:head>
	<title>{$_('account.forgotPassword') + ' ' + $_('message.page')}</title>
</svelte:head>
		...
		{#if deviceType === config.isMobile}
			...
			<div class="content-mobile">
				<Breadcrumb>
					<BreadcrumbItem
						active={true}
						message={$_('account.forgotPassword')}
					/>
				</Breadcrumb>
				<section class="pt2rem spacing-ext flex items-center justify-center">
					<div class="tc">
						<h1 class="page__title ttc tc dark-blue w-90 center">
							{$_('account.forgotYourPassword')}
						</h1>
						<PcForgotPassword onSuccess={goToSignIn} />
					</div>
				</section>
			...
			<div class="content-desktop">
				...
				<section class="mw10 center pv6">
					<div class="flex items-center justify-between">
						<div class="w5">
							<div class="dark-blue f2 b tc">
								{$_('account.forgotYourPassword')}
							</div>
							<PcForgotPassword onSuccess={goToSignIn} />
							<div class="w5 mt5 tc justify-center">
								<PcSignInSocial />
							</div>
						</div>
						...
						<div class="w5">
							<LazyImage
								src="images/bg-forgot-password.svg"
								alt={$_('account.forgotPassword')}
								width="470px"
								height="375px"
							/>
							<div class="pt5 tc">
								<h2 class="near-black">One of us?</h2>
