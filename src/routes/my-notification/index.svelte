<script>
	...
	import PcMyNotification from '../../components/myNotification/PcMyNotification.svelte';
	import MobileMyNotification from '../../components/myNotification/MobileMyNotification.svelte';
