<script>
	...
	import PcCompare from '../../components/compare/PcCompare.svelte';
	import { compareItemOne, compareItemTwo } from '../../stores';
	import TabletCompare from '../../components/compare/TabletCompare.svelte';
	import MobileCompare from '../../components/compare/MobileCompare.svelte';
...
{#if visible}
	<TransactionWrapper id="compare-screen">
		{#if deviceType === config.isMobile}
			<MobileNav />
			<div class="content-mobile">
				<Breadcrumb>
					<BreadcrumbItem active={true} message={$_('label.compare')} />
				</Breadcrumb>
